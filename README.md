...
It uses jupyter noteboooks and each stage of the pipeline can be run stand-alone or as part of work flow controlled by a "master notebook" that uses [papermill](https://papermill.readthedocs.io/en/latest/). 
